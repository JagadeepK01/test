...
from operators.neu_dataops_postgres_cloud_operator import NeuDataOpsPostgresCloudOperator
...
def extract_oracle(table_name, chunks, **kwargs):
    ...
    client = NeuDataOpsPostgresCloudOperator(username = config.user, password = config.password, dsn_string = config.dsn)
